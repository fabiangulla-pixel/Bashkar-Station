...
def generar_methods_md(
    ...
    lineas = [
        ...
        "una aplicación de escritorio desarrollada específicamente para el análisis",
        "de publicaciones periódicas históricas en español.",
        "",
        "| Software | Versión |",
        "|---|---|",
        f"| Python | {py_ver} |",
    ...
    lineas += [
        ...
        "- Modo de segmentación de página (PSM): detección automática de layout",
        "",
        "Los PDFs de la colección BNC están digitalizados con Adobe Acrobat Paper Capture,",
        "que embebe el reconocimiento óptico en un formato posicional (fuente HiddenHorzOCR).",
        "Bashkar Station aplica un reconstructor de orden de lectura basado en coordenadas",
        "X/Y para recuperar el flujo correcto de columnas múltiples.",
        "",
        "### 2.2 Normalización post-OCR",
        "",
        "La normalización preserva la ortografía histórica del español de los años 1930",
        "(arcaísmos, formas verbales, diacríticos no estándar) y corrige únicamente errores",
        "de digitalización: caracteres confundidos por el OCR, palabras partidas por guión",
        "de columna, ruido tipográfico.",
        "",
    ...
    lineas += [
        ...
        "  `mrm8488/bert-spanish-cased-finetuned-ner` (capa 2, BERT local)",
    ]
    ...
    lineas += [
        ...
        "---",
        "",
        "## 4. Análisis léxico y estadístico",
        "",
        "- Frecuencias de términos calculadas sobre el corpus completo.",
        "- Collocates extraídos con ventana de 5 tokens y métrica PMI",
        "  (Pointwise Mutual Information).",
        "- Topic modeling mediante LDA (Latent Dirichlet Allocation) con scikit-learn.",
        "",
        "---",
        "",
        "## 5. Reproducibilidad",
        "",
        "Todos los parámetros y versiones de software registrados en este documento",
        "permiten la reproducción del análisis. Los archivos generados incluyen:",
        "",
        "- `corpus.xml` — transcripciones en formato TEI P5",
        "- `corpus.bib` — referencias bibliográficas en BibTeX",
        "- `entidades.csv` — índice completo de entidades nombradas",
        "- `bitacora.md` — notas y reflexiones del investigador durante el proceso",
        "- `METHODS.md` — este documento",
        "",
        "---",
        "",
