...
_STOPWORDS_EXTRA = {
    "uno", "una", "unos", "unas", "todo", "todos", "toda", "todas",
    "esto", "esta", "este", "estos", "estas", "eso", "esa", "ese", "esos", "esas",
    "aquel", "aquello", "cómo", "como", "cuándo", "cuando", "dónde", "donde",
    "qué", "que", "quien", "quién", "cual", "cuál", "porque", "porqué",
    "sólo", "solo", "más", "menos", "muy", "tan", "tanto", "también", "tampoco",
    "él", "ella", "ellos", "ellas", "ser", "estar", "haber", "tener", "hacer",
    "decir", "ver", "dar", "ir", "poder", "deber", "era", "fue", "han", "hay",
    "puede", "dice", "está", "había", "sido", "siendo", "allí", "aquí", "ahí",
    "entonces", "ahora", "luego", "después", "antes", "siempre", "nunca",
    "mismo", "misma", "cada", "otro", "otra", "otros", "otras", "alguno",
    "alguna", "algún", "ningún", "primero", "primera", "último", "última",
    "gran", "grande", "mejor", "mayor", "menor", "nuevo", "nueva", "medio",
    "hombre", "vida", "casa", "día", "días", "año", "años", "vez", "veces",
    "momento", "tiempo", "hora", "parte", "punto", "manera", "modo", "cosa",
    "señor", "señora", "don", "doña", "usted", "ustedes",
    # marcadores del sistema / OCR — NO son del corpus
    "ilegible", "pág", "pag", "página", "pagina",
}
...
_RUIDO_OCR_FIJO = {
    "ns", "ro", "pa", "ol", "et", "fo", "ea", "ce", "des", "enel", "tre",
    "pre", "pro", "ton", "vo", "ve", "ma", "po", "mó", "na", "ho", "di",
    "ra", "cra", "coso", "caso", "tos", "ele", "fa", "ber", "ción", "mente",
    # errores OCR recurrentes en el corpus Estampa (no son palabras de contenido)
    "poro", "poo", "rir", "tir", "ica", "ene", "rca", "colomll",
    "beneiicencio", "merizald",
}
...
def nube_palabras(
    ...
    stops.update(["que", "de", "la", "el", "en", "y", "a", "los", "las",
                   "un", "una", "es", "por", "con", "del", "se", "le", "su",
                   "al", "no", "lo", "más", "pero", "este", "esta", "ha",
                   "para", "como", "sus", "muy", "también", "fue"])
    if stopwords_extra:
...
def nubes_comparativas(
    ...
    stops = {"que", "de", "la", "el", "en", "y", "a", "los", "las",
             "un", "una", "es", "por", "con", "del", "se", "le", "su",
             "al", "no", "lo", "más", "pero", "este", "esta", "ha",
             "para", "como", "sus", "muy", "también", "fue"}
    ...
    for ax, (etiqueta, textos) in zip(axes, grupos.items()):
        ...
        wc = WordCloud(width=600, height=400, background_color="white",
                       stopwords=stops, max_words=100, collocations=False,
                       colormap="plasma").generate(texto or "sin datos")
        ax.imshow(wc, interpolation="bilinear")
        ax.axis("off")
...
def _cargar_coords() -> dict:
    ...
    return {
        ...
        "medellín": (6.2518, -75.5636), "medellin": (6.2518, -75.5636),
        "cali": (3.4516, -76.5319), "barranquilla": (10.9639, -74.7964),
        "cartagena": (10.3910, -75.4794), "colombia": (4.5709, -74.2973),
    }
...
def timeline_html(
    ...
    for i, ev in enumerate(eventos):
        ...
        items_js.append(
            f"{{id:{i}, content:'{tit}', start:'{fecha}', "
            f"title:'{desc}', group:'{cat}'}}"
        )
