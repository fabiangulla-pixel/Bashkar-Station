...
_POS = {
    ...
    "digno", "dignidad", "esperanza", "armonía", "armonia", "paz", "fe",
    "entusiasmo", "alegría", "alegria", "festejo", "felicidad", "virtud",
    "talento", "genio", "sabio", "sabiduría", "sabiduria", "heroico", "heroísmo",
    "heroismo", "valiente", "valor", "fortuna", "favorable",
}
_NEG = {
    "crisis", "escándalo", "escandalo", "tragedia", "trágic", "tragic", "drama",
    ...
    "tiranía", "tirania", "opresión", "opresion", "barbarie", "salvaje", "cruel",
    "crueldad", "odio", "rencor", "enemigo", "ruin", "vil", "mezquino",
